...
class SegmentPotentialEnergyFunctionCharacterizer(CompositeuFJCScissionCharacterizer):
    ...
    def finalization(self):
        ...
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$\tilde{u}_{\nu}$', 20, "composite-u_nu-contributions-vs-lmbda_nu")
        ...
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$\overline{u}_{\nu}$', 20, "anharmonic-overline_u_nu-vs-lmbda_nu")
        ...
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$u_{\nu}$', 20, "morse-lj-u_nu-vs-lmbda_nu")
        ...
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$u_{\nu}$', 20, "anharmonic-u_nu-vs-lmbda_nu")
