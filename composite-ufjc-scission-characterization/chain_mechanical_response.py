...
class ChainMechanicalResponseCharacterizer(CompositeuFJCScissionCharacterizer):
    ...
    def characterization(self):
        ...
        chain_mech_resp_zeta_nu_char_single_chain_list = [CompositeuFJC(rate_dependence = 'rate_independent', nu = cp.nu_single_chain_list[1], zeta_nu_char = cp.zeta_nu_char_single_chain_list[single_chain_indx], kappa_nu = cp.kappa_nu_single_chain_list[2]) for single_chain_indx in range(len(cp.zeta_nu_char_single_chain_list))] # nu=125, kappa_nu=1000
        ...
        # Evaluate kappa_nu
        chain_mech_resp_kappa_nu_single_chain_list = [CompositeuFJC(rate_dependence = 'rate_independent', nu = cp.nu_single_chain_list[1], zeta_nu_char = cp.zeta_nu_char_single_chain_list[2], kappa_nu = cp.kappa_nu_single_chain_list[single_chain_indx]) for single_chain_indx in range(len(cp.kappa_nu_single_chain_list))] # nu=125, zeta_nu_char=1000
