...
class EquilibriumChainStretchFunctionCharacterizer(CompositeuFJCScissionCharacterizer):
    ...
    def finalization(self):
        ...
        plt.plot(self.lmbda_nu, self.lmbda_c_eq_exact, linestyle='-', color='red', alpha=1, linewidth=2.5, label=r'$\textrm{Highly accurate numerical solution}$')
        ...
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$\lambda_c^{eq}$', 20, "lmbda_c_eq-vs-lmbda_nu-exact-and-approximated-solutions")
        ...
        ax1.plot(self.lmbda_nu, self.lmbda_c_eq_exact, linestyle='-', color='red', alpha=1, linewidth=2.5, label=r'$\textrm{Highly accurate numerical solution}$')
        ...
        plt.yticks(fontsize=14)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$\lambda_c^{eq} - \lambda_{\nu} + 1$', 20, "lmbda_comp_nu-vs-lmbda_nu")
