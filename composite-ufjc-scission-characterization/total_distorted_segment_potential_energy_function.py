"""The total distorted segment potential energy characterization module
for composite uFJCs
"""
...
class TotalDistortedSegmentPotentialEnergyFunctionCharacterizer(
        CompositeuFJCScissionCharacterizer):
    """The characterization class assessing the total distorted segment
    potential energy for composite uFJCs. It inherits all attributes and
    methods from the ``CompositeuFJCScissionCharacterizer`` class.
    """
    def __init__(self):
        """Initializes the
        ``TotalDistortedSegmentPotentialEnergyFunctionCharacterizer``
    ...
    def characterization(self):
        ...
        u_nu_locmin_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        overline_u_nu_locmin_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        lmbda_nu_locmax_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        u_nu_locmax_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        overline_u_nu_locmax_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        lmbda_nu___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        u_nu_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        overline_u_nu_hat___hat_chunk = [
            0. for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num)
        ]
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            ...
            u_nu_locmin_hat = (
                single_chain.u_nu_hat_func(lmbda_nu_hat, lmbda_nu_locmin_hat)
            )
            lmbda_nu_locmax_hat = (
            ...
            for lmbda_nu_indx in range(lmbda_nu_num_steps):
                ...
                u_nu_hat_val = (
                    single_chain.u_nu_hat_func(lmbda_nu_hat, lmbda_nu_val)
                )
                
                lmbda_nu.append(lmbda_nu_val)
                u_nu_hat.append(u_nu_hat_val)
            
            overline_u_nu_locmin_hat = (
                u_nu_locmin_hat / single_chain.zeta_nu_char
            )
            overline_u_nu_locmax_hat = (
                u_nu_locmax_hat / single_chain.zeta_nu_char
            )
            overline_u_nu_hat = [
                u_nu_hat_val/single_chain.zeta_nu_char
                for u_nu_hat_val in u_nu_hat
            ]
            ...
            overline_u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx] = (
                overline_u_nu_locmin_hat
            )
            ...
            overline_u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx] = (
                overline_u_nu_locmax_hat
            )
        ...
        self.overline_u_nu_locmin_hat___hat_chunk = (
            overline_u_nu_locmin_hat___hat_chunk
        )
        ...
        self.overline_u_nu_locmax_hat___hat_chunk = (
            overline_u_nu_locmax_hat___hat_chunk
        )
    ...
    def finalization(self):
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            ...
            overline_u_nu_locmin_hat = (
                self.overline_u_nu_locmin_hat___hat_chunk[lmbda_nu_hat_indx]
            )
            lmbda_nu_locmax_hat = (
                self.lmbda_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            )
            overline_u_nu_locmax_hat = (
                self.overline_u_nu_locmax_hat___hat_chunk[lmbda_nu_hat_indx]
            )
            lmbda_nu = self.lmbda_nu___hat_chunk[lmbda_nu_hat_indx]
            overline_u_nu_hat = (
                self.overline_u_nu_hat___hat_chunk[lmbda_nu_hat_indx]
            )
            plt.plot(
                lmbda_nu, overline_u_nu_hat, linestyle='-',
                color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5,
                label=chain_parameter_label_list[lmbda_nu_hat_indx])
            plt.plot(
                lmbda_nu_locmin_hat, overline_u_nu_locmin_hat, marker='o',
                color=cp.color_list[lmbda_nu_hat_indx], alpha=1, linewidth=2.5)
            if lmbda_nu_locmax_hat == np.inf:
                continue
            else:
                plt.plot(
                    lmbda_nu_locmax_hat, overline_u_nu_locmax_hat, marker='s',
                    color=cp.color_list[lmbda_nu_hat_indx], alpha=1,
                    linewidth=2.5)
        plt.legend(loc='best', fontsize=12)
        plt.xlim([lmbda_nu[0], lmbda_nu[-1]])
