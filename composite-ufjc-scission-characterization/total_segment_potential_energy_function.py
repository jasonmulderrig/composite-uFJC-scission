...
class TotalSegmentPotentialEnergyFunctionCharacterizer(CompositeuFJCScissionCharacterizer):
    ...
    def characterization(self):
        ...
        for lmbda_nu_hat_indx in range(cp.lmbda_nu_hat_num):
            ...
            u_nu_tot_locmin_hat = single_chain.u_nu_tot_hat_func(lmbda_nu_hat, lmbda_nu_locmin_hat)
            ...
            if lmbda_nu_locmax_hat == np.inf:
                ...
                u_nu_tot_locmax_hat = single_chain.u_nu_tot_hat_func(lmbda_nu_hat, lmbda_nu_locmax_hat)
            ...
            for lmbda_nu_indx in range(lmbda_nu_num_steps):
                ...
                u_nu_tot_hat_val = single_chain.u_nu_tot_hat_func(lmbda_nu_hat, lmbda_nu_val)
    ...
    def finalization(self):
        ...
        plt.yticks(fontsize=16)
        plt.grid(True, alpha=0.25)
        save_current_figure(self.savedir, r'$\lambda_{\nu}$', 20, r'$\overline{\hat{u}}_{\nu}^{tot}$', 20, "overline_u_nu_tot_hat-vs-lmbda_nu")
