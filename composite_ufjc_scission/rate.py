...
class RateDependenceScissionCompositeuFJC(ScissionModelCompositeuFJC):
    ...
    def epsilon_nu_diss_hat_func(self, p_nu_sci_hat_val,
            p_nu_sci_hat_cum_intgrl_val, t_val, lmbda_nu_hat_val, t_prior,
    ...
    def epsilon_cnu_diss_hat_func(self, p_nu_sci_hat_val,
            p_nu_sci_hat_cum_intgrl_val, t_val, lmbda_nu_hat_val, t_prior,
    ...
    def epsilon_cnu_diss_hat_func(self, lmbda_nu_hat_max, lmbda_nu_hat_val,
            lmbda_nu_hat_val_prior, epsilon_cnu_diss_hat_val_prior):
    ...
    def expctd_val_epsilon_cnu_sci_hat_intgrnd_func(
        ...
        # scission energy cannot be destroyed
        if lmbda_nu_hat_val < lmbda_nu_hat_max:
            return expctd_val_epsilon_cnu_sci_hat_intgrnd_val_prior
        # statistical expected value of the nondimensional chain
